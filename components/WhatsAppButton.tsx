...
const WhatsAppButton: React.FC = () => {
    ...
    return (
        <button
            onClick={handleClick}
            className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20bd5a] text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center group"
            aria-label="Contactar por WhatsApp"
            style={{ boxShadow: '0 4px 10px rgba(37, 211, 102, 0.5)' }}
        >
            <svg
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <span className="hidden group-hover:block whitespace-nowrap text-white font-bold text-sm ml-2 transition-opacity duration-300">
                Chatea con nosotros
            </span>
        </button>
    );
